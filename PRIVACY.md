...
- When Speed mode is enabled, the current conversation detail API response is kept in the page's JavaScript memory only so more messages can be rendered from cache without repeated API calls.
